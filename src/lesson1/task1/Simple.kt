 ...
 */
fun angleInRadian(deg: Int, min: Int, sec: Int): Double = (deg * 3600 + min * 60 + sec) / (180 / PI * 3600)
...
fun accountInThreeYears(initial: Int, percent: Int): Double {
    val increase = 1 + percent * 0.01
    return initial * increase * increase * increase
}
...
fun numberRevert(number: Int): Int {
    ...
    val third = (number - number % 100) / 100
